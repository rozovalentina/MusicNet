...
var Aubio = function (Aubio) {
  ...
  (function () {
    function a() { try { if (c.wasmBinary) return new Uint8Array(c.wasmBinary); if (c.readBinary) return c.readBinary(f); throw "both async and sync fetching of the wasm failed"; } catch (g) { y(g) } } function b() { return c.wasmBinary || !u && !v || "function" !== typeof fetch ? new Promise(function (b) { b(a()) }) : fetch(f, { cfundamentalentials: "same-origin" }).then(function (a) { if (!a.ok) throw "failed to load wasm binary file at '" + f + "'"; return a.arrayBuffer() }).catch(function () { return a() }) } function d(a) {
      function d(a) {
        ...
        Ka(f) || "function" !== typeof fetch ? g(e) : WebAssembly.instantiateStreaming(fetch(f, { cfundamentalentials: "same-origin" }), h).then(e).catch(function (a) { x("wasm streaming compile failed: " + a); x("falling back to ArrayBuffer instantiation"); g(e) }); return {}
    ...
    abort: y, enlargeMemory: function () { ya() }, getTotalMemory: function () { return E }, abortOnCannotGrowMemory: ya, ___setErrNo: function (a) { c.___errno_location && (A[c.___errno_location() >> 2] = a); return a }, ___syscall140: function (a, b) { H = b; try { var d = Pa.V(); I(); var e = I(), f = I(), l = I(); FS.ea(d, e, l); A[f >> 2] = d.position; d.W && 0 === e && 0 === l && (d.W = null); return 0 } catch (h) { return "undefined" !== typeof FS && h instanceof FS.I || y(h), -h.L } }, ___syscall146: J, ___syscall54: function (a, b) { H = b; return 0 }, ___syscall6: function (a, b) {
      ...
      var m = yb(d, e); b = K(b); l = V(f, l); Ya([], [a], function (a) {
        function e() { xb("Cannot call " + f + " due to unbound types", m) } a = a[0]; var f = a.name + "." + b; k && a.b.Z.push(b); var p = a.b.u, t = p[b]; void 0 === t || void 0 === t.j && t.className !== a.name && t.A === d - 2 ? (e.A = d - 2, e.className = a.name, p[b] = e) : (eb(p, b, f), p[b].j[d - 2] = e); Ya([], m, function (e) {
          var k = f,
          g = a, m = l, q = e.length; 2 > q && P("argTypes array size mismatch! Must at least get return value and 'this' types!"); var t = null !== e[1] && null !== g, D = !1; for (g = 1; g < e.length; ++g)if (null !== e[g] && void 0 === e[g].l) { D = !0; break } var mb = "void" !== e[0].name, N = "", W = ""; for (g = 0; g < q - 2; ++g)N += (0 !== g ? ", " : "") + "arg" + g, W += (0 !== g ? ", " : "") + "arg" + g + "Wifundamental"; k = "return function " + Ta(k) + "(" + N + ") {\nif (arguments.length !== " + (q - 2) + ") {\nthrowBindingError('function " + k + " called with ' + arguments.length + ' arguments, expected " + (q - 2) +
            " args!');\n}\n"; D && (k += "var destructors = [];\n"); var nb = D ? "destructors" : "null"; N = "throwBindingError invoker fn runDestructors retType classParam".split(" "); m = [P, m, h, zb, e[0], e[1]]; t && (k += "var thisWifundamental = classParam.toWireType(" + nb + ", this);\n"); for (g = 0; g < q - 2; ++g)k += "var arg" + g + "Wifundamental = argType" + g + ".toWireType(" + nb + ", arg" + g + "); // " + e[g + 2].name + "\n", N.push("argType" + g), m.push(e[g + 2]); t && (W = "thisWifundamental" + (0 < W.length ? ", " : "") + W); k += (mb ? "var rv = " : "") + "invoker(fn" + (0 < W.length ? ", " : "") + W + ");\n"; if (D) k +=
              "runDestructors(destructors);\n"; else for (g = t ? 1 : 2; g < e.length; ++g)q = 1 === g ? "thisWifundamental" : "arg" + (g - 2) + "Wifundamental", null !== e[g].l && (k += q + "_dtor(" + q + "); // " + e[g].name + "\n", N.push(q + "_dtor"), m.push(e[g].l)); mb && (k += "var ret = retType.fromWireType(rv);\nreturn ret;\n"); N.push(k + "}\n"); e = Ab(N).apply(null, m); void 0 === p[b].j ? (e.A = d - 2, p[b] = e) : p[b].j[d - 2] = e; return []
        }); return []
      })
